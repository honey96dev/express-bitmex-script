        ...
        this.table = $('#users').DataTable({
            ...
            columns: [
                ...
                // },
                {
                    ...
                    data: "id",
                    render: function (data, type, row) {
                        return '<button class="btn btn-clean btn-sm btn-icon" onclick="users.deleteBitMEXAccount(' + data + ')"><i class="fa fa-trash margin-auto"></i></button>';
                    },
                    orderable: false,
                }
            ],
